...
// per pixel — a stand-in, drawn here, for the show the real sphere runs.
//
...
// 220-seat interior are the client's figures. What runs on the display is not: we
// have no capture of the sphere's own show, so the surface is a grid of LED cells
// generated per pixel, in the palette of the real one. The panel says so on the
// page. Swap it for real footage by sampling a video texture in display() — see
// CREDITS.md.
(function () {
