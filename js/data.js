...
window.WBK = {
  ...
  restaurants: [
    { name: "Tante", zone: "Egypt", cuisine: "EGYPTIAN", img: "egypt.jpg",
      brand: { plate: "#2b1410", ink: "#f4cf95", mark: "lotus", word: "TANTE", tag: "CAIRO KITCHEN" },
      food: "nile.webp", from: 180,
    ...
    { name: "Superheroes Restaurant", cuisine: "THEMED DINING", img: "park2.jpg",
      brand: { plate: "#1a1033", ink: "#ffd94d", mark: "bolt", word: "SUPERHEROES", tag: "EST. BLVD WORLD" },
      food: "route66.webp", from: 120,
    ...
    { name: "Sakura Lounge", zone: "Japan", cuisine: "JAPANESE FUSION", img: "japan.jpg",
      brand: { plate: "#2a1020", ink: "#ffc6d7", mark: "blossom", word: "SAKURA", tag: "LOUNGE \u00b7 \u685c" },
      food: "sakura.webp", from: 220,
    ...
    { name: "EOS Restaurant", zone: "Greece", cuisine: "MEDITERRANEAN", img: "greece.webp",
      brand: { plate: "#0b2334", ink: "#ffe4b3", mark: "sun", word: "EOS", tag: "GREEK TABLE" },
      food: "eos.webp", from: 200,
  ...
  faqs: [
    ...
    { q: "What does the entry ticket include?",
      a: "Entry gives you access to BLVD World and every walkable zone \u2014 the streets, plazas, souks and light shows. Individual rides, dining and ticketed experiences are booked separately." },
    { q: "What are the opening hours?",
      a: "BLVD World opens in the late afternoon and runs past midnight through the Season. Exact times shift by day, so check your ticket for the night you're visiting." },
