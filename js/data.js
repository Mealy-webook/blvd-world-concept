...
window.WBK = {
  ...
  zones: [
    { name: "Saudi Arabia",  lat: 24.7,  lon: 46.7,   blurb: "Najdi streets, kabsa on the grill, ardah at volume." , imgs: ["saudi-arabia.webp", "saudi.jpg", "park2.jpg"], attractions: ["Najdi Heritage Village", "Falcon Show Arena", "Traditional Ardah Stage"], food: ["Najd Grill House", "Qahwa & Dates Lounge", "Kabsa Kitchen"], rides: ["Desert Rover Coaster", "Camel Carousel"] },
    { name: "Egypt",         lat: 26.8,  lon: 30.8,   blurb: "The Sphinx by night, then a live PUBG arena." , imgs: ["egypt.webp", "egypt.jpg", "park4.jpg"], attractions: ["Pyramid Light Show", "PUBG Experience Zone", "Sphinx Plaza"], food: ["Nile Terrace", "Koshari Corner"], rides: ["Pharaoh's Drop Tower", "Scarab Spinner"] },
    { name: "France",        lat: 46.6,  lon: 2.2,    blurb: "The Eiffel Tower over an alpine high street." , imgs: ["france.webp", "france.jpg", "park1.jpg"], attractions: ["Eiffel Tower Replica", "Courchevel Snow Deck", "Street Mime Quarter"], food: ["Le Petit Bistro", "Cr\u00eaperie du Parc", "Champs Caf\u00e9"], rides: ["Grand Carousel", "Balloon Ascent"] },
    ...
    { name: "Japan",         lat: 36.2,  lon: 138.3,  blurb: "Under the torii: neon arcades and warm taiyaki." , imgs: ["japan.webp", "japan.jpg", "park1.jpg"], attractions: ["Tokyo Street", "Grendizer Statue", "Retro Arcade Hall"], food: ["Ramen Yokocho", "Sushi Counter", "Taiyaki Stand"], rides: ["Neon Drift Racers", "Robot Drop"] },
    { name: "Indonesia",     lat: -2.5,  lon: 118.0,  blurb: "Palms lit in neon, island craft, a thatched stage." , imgs: ["indonesia.webp", "park1.jpg", "park7.jpg"], attractions: ["Bali Water Garden", "Batik Craft House", "Island Dance Stage"], food: ["Warung Nasi", "Satay Grill"], rides: ["Volcano Splash", "Tiki Swing"] },
    { name: "South Korea",   lat: 36.5,  lon: 127.9,  blurb: "K-pop on stage, Korean BBQ, Seoul Tower above." , imgs: ["korea.webp", "park6.jpg", "park3.jpg"], attractions: ["K-Pop Plaza", "Hanok Lane", "Seoul Neon Alley"], food: ["Korean BBQ House", "Bingsu Bar", "Street Toast Stand"], rides: ["Hallyu Spin", "Seoul Sky Tower"] },
    ...
    { name: "Kuwait",        lat: 29.3,  lon: 47.5,   blurb: "The Kuwait Towers glowing over a fortress gate." , imgs: ["kuwait.webp", "park4.jpg", "park2.jpg"], attractions: ["Kuwait Towers Replica", "Gulf Promenade", "Pearl Diving Exhibit"], food: ["Machboos House", "Gulf Seafood Deck"], rides: ["Dhow Boat Ride", "Pearl Spinner"] },
    ...
    { name: "Türkiye",       lat: 39.0,  lon: 35.2,   blurb: "Uzungöl terraces, folk dance, shisha as it cools." , imgs: ["turkey.jpg", "park6.jpg", "park2.jpg"], attractions: ["Uzung\u00f6l Terraces", "Galata Tower Replica", "Whirling Dervish Stage"], food: ["Uzung\u00f6l Restaurant & Shisha", "Baklava House", "Turkish Coffee Nook"], rides: ["Bosphorus Flyer", "Ottoman Carousel"] },
