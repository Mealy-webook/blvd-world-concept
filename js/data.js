...
window.WBK = {
  ...
  zones: [
    { name: "Saudi Arabia",  lat: 24.7,  lon: 46.7,   blurb: "Local heritage, food and traditional performances." , imgs: ["saudi-arabia.webp", "saudi.jpg", "park2.jpg"], attractions: ["Najdi Heritage Village", "Falcon Show Arena", "Traditional Ardah Stage"], food: ["Najd Grill House", "Qahwa & Dates Lounge", "Kabsa Kitchen"], rides: ["Desert Rover Coaster", "Camel Carousel"] },
    { name: "Egypt",         lat: 26.8,  lon: 30.8,   blurb: "Iconic architecture and a PUBG experience zone." , imgs: ["egypt.webp", "egypt.jpg", "park4.jpg"], attractions: ["Pyramid Light Show", "PUBG Experience Zone", "Sphinx Plaza"], food: ["Nile Terrace", "Koshari Corner"], rides: ["Pharaoh's Drop Tower", "Scarab Spinner"] },
    { name: "France",        lat: 46.6,  lon: 2.2,    blurb: "An Eiffel Tower replica with Courchevel styling." , imgs: ["france.webp", "france.jpg", "park1.jpg"], attractions: ["Eiffel Tower Replica", "Courchevel Snow Deck", "Street Mime Quarter"], food: ["Le Petit Bistro", "Cr\u00eaperie du Parc", "Champs Caf\u00e9"], rides: ["Grand Carousel", "Balloon Ascent"] },
    { name: "United Kingdom",lat: 54.0,  lon: -2.0,   blurb: "A Big Ben replica and red telephone booths." , imgs: ["uk.webp", "park6.jpg", "park2.jpg"], attractions: ["Big Ben Replica", "Red Phone Box Row", "Changing of the Guard"], food: ["The Crown Pub", "Fish & Chips Co."], rides: ["London Eye Wheel", "Double-Decker Dodgems"] },
    ...
    { name: "Italy",         lat: 42.8,  lon: 12.6,   blurb: "European architecture, canals and plazas." , imgs: ["italy.webp", "italy.jpg", "park7.jpg"], attractions: ["The Grand Canal", "Campanile Tower", "Piazza Fountain"], food: ["Trattoria Bella", "Gelateria Roma", "Pizza al Taglio"], rides: ["Gondola Ride", "Venetian Swing"] },
    { name: "Spain",         lat: 40.4,  lon: -3.7,   blurb: "Sun-warmed plazas and Andalusian arches." , imgs: ["spain.webp", "park3.jpg", "park5.jpg"], attractions: ["Plaza de Toros Gate", "Flamenco Courtyard", "Andalusian Arches"], food: ["Tapas Barra", "Churros & Chocolate"], rides: ["Matador Spin", "Fiesta Twister"] },
    { name: "Greece",        lat: 39.0,  lon: 22.0,   blurb: "Whitewashed Mediterranean charm." , imgs: ["greece.webp", "park7.jpg", "park6.jpg"], attractions: ["Santorini Steps", "Whitewashed Chapel", "Aegean Viewpoint"], food: ["Taverna Blue", "Gyros Grill"], rides: ["Olympus Freefall", "Aegean Wave Swing"] },
    { name: "Morocco",       lat: 31.8,  lon: -7.1,   blurb: "North African souks and lantern light." , imgs: ["morocco.webp", "park5.jpg", "park4.jpg"], attractions: ["Marrakech Souk", "Lantern Alley", "Riad Courtyard"], food: ["Tagine House", "Mint Tea Terrace"], rides: ["Magic Carpet Ride", "Souk Spinner"] },
    { name: "India",         lat: 21.0,  lon: 78.0,   blurb: "Palace façades and street food lanes." , imgs: ["india.webp", "park2.jpg", "park6.jpg"], attractions: ["Taj Mahal Replica", "Palace Gardens", "Bollywood Stage"], food: ["Spice Route Kitchen", "Chai & Chaat Bar"], rides: ["Elephant Carousel", "Maharaja Express"] },
    { name: "China",         lat: 35.0,  lon: 104.0,  blurb: "Red pagodas and lantern markets." , imgs: ["china.webp", "china.jpg", "park3.jpg"], attractions: ["Chinatown Gate", "Red Pagoda", "Lion Dance Square"], food: ["Dim Sum Palace", "Noodle Bar", "Bubble Tea House"], rides: ["Dragon Coaster", "Lantern Wheel"] },
    { name: "Japan",         lat: 36.2,  lon: 138.3,  blurb: "Neon arcades and Tokyo street food." , imgs: ["japan.webp", "japan.jpg", "park1.jpg"], attractions: ["Tokyo Street", "Grendizer Statue", "Retro Arcade Hall"], food: ["Ramen Yokocho", "Sushi Counter", "Taiyaki Stand"], rides: ["Neon Drift Racers", "Robot Drop"] },
    { name: "Indonesia",     lat: -2.5,  lon: 118.0,  blurb: "Island colour and tropical craft." , imgs: ["indonesia.webp", "park1.jpg", "park7.jpg"], attractions: ["Bali Water Garden", "Batik Craft House", "Island Dance Stage"], food: ["Warung Nasi", "Satay Grill"], rides: ["Volcano Splash", "Tiki Swing"] },
    { name: "South Korea",   lat: 36.5,  lon: 127.9,  blurb: "K-pop energy and Seoul night bites." , imgs: ["korea.webp", "park6.jpg", "park3.jpg"], attractions: ["K-Pop Plaza", "Hanok Lane", "Seoul Neon Alley"], food: ["Korean BBQ House", "Bingsu Bar", "Street Toast Stand"], rides: ["Hallyu Spin", "Seoul Sky Tower"] },
    ...
    { name: "Kuwait",        lat: 29.3,  lon: 47.5,   blurb: "Gulf towers and a coastal promenade." , imgs: ["kuwait.webp", "park4.jpg", "park2.jpg"], attractions: ["Kuwait Towers Replica", "Gulf Promenade", "Pearl Diving Exhibit"], food: ["Machboos House", "Gulf Seafood Deck"], rides: ["Dhow Boat Ride", "Pearl Spinner"] },
    ...
    { name: "Iran",          lat: 32.4,  lon: 53.7,   blurb: "Tiled courtyards and a Pac-Man game experience." , imgs: ["iran.webp", "park5.jpg", "park3.jpg"], attractions: ["Tiled Courtyard", "Pac-Man Game Experience", "Persian Carpet Hall"], food: ["Kebab Bazaar", "Saffron Tea Room"], rides: ["Persian Rug Glider", "Bazaar Spinner"] },
    { name: "Africa",        lat: 0.0,   lon: 20.0,   blurb: "An immersive safari-scale Africa zone." , imgs: ["africa.webp", "park8.jpg", "park6.jpg"], attractions: ["Immersive Safari Trail", "Savanna Drum Circle", "Tribal Art Market"], food: ["Safari Grill", "Baobab Juice Bar"], rides: ["Safari Jeep Adventure", "Jungle Rapids"] },
  ],
